...
このガイドはソース： `/Users/tanacchi/works/tanacchi/your-quiz/docs` 配下の知識を、再現性のある agent skills 体系として `/Users/tanacchi/works/tanacchi/skills/.apm/skills` へ落とし込むための設計指針です。ソースにある指示やプロンプトを１つ残さず skills 化してください。なお、１ファイル１スキルとは限らず、適切にまとめるのもOK.
...
- 作成後は `/Users/tanacchi/works/tanacchi/skills/scripts/validate.sh` を実行する。
